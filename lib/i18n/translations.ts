...
export const translations = {
  ...
  hero: {
    ...
    typewriterPhrases: {
      en: ['Front-End Developer', 'React & Next.js Engineer', 'UI/UX Enthusiast', 'Entrepreneur & Innovator'],
      ar: ['مطوّر واجهات أمامية', 'مهندس React & Next.js', 'مصمم تجارب مستخدم', 'رائد أعمال ومبتكر'],
    },
    stats: {
  ...
  business: {
    ...
    infinityBright: {
      ...
      tagline:    { en: 'Car Protection Services · Riyadh, Saudi Arabia', ar: 'خدمات حماية السيارات · الرياض، المملكة العربية السعودية' },
      badge:      { en: '3M Authorised Dealer',              ar: 'وكيل معتمد من 3M' },
      desc:       {
    ...
    timeline: {
      ...
      items: [
        {
          year:    '2023 – Present',
          title:   { en: 'Front-End Engineer & Founder',   ar: 'مهندس واجهات أمامية ومؤسس' },
        ...
        },
        {
          ...
          company: { en: 'INFINITY BRIGHT — Car Protection', ar: 'إنفينيتي برايت — حماية السيارات' },
          desc:    {
    ...
    categories: [
      ...
      },
      {
        ...
        skills: [
          ...
          { name: { en: 'Brand Strategy',   ar: 'استراتيجية العلامة' }, level: 82 },
      ...
      },
      {
        ...
        icon: '🗄️',
        skills: [
          { name: { en: 'Node.js (Learning)', ar: 'Node.js (قيد التعلم)' }, level: 40 },
  ...
  contact: {
    ...
    infoCards: {
      ...
      location:   { en: 'Location',        ar: 'الموقع' },
      locationVal:{ en: 'Riyadh, Saudi Arabia', ar: 'الرياض، المملكة العربية السعودية' },
  ...
  chatbot: {
    ...
    quickPrompts: {
      en: ['Tell me about Darak', 'What skills does Salah have?', 'How can I hire Salah?'],
  ...
  footer: {
    ...
    using: { en: 'using Next.js & Tailwind CSS.', ar: 'باستخدام Next.js و Tailwind CSS.' },
  },
} as const
